...
CUSTOM_HAL_IMGSENSOR = gc2355_mipi_raw  gc0312_yuv
...
CUSTOM_KERNEL_IMGSENSOR = gc2355_mipi_raw gc0312_yuv
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = nt35521_wxga_dsi_vdo_douglas
...
CUSTOM_LK_LCM = nt35521_wxga_dsi_vdo_douglas
CUSTOM_MODEM =
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = nt35521_wxga_dsi_vdo_douglas
...
MTK_DT_SUPPORT = no
MTK_DUAL_INPUT_CHARGER_SUPPORT = yes
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_platform_mt8163 rel_customer_tablet rel_customer_modem
...
MTK_AUDIO_CUST_EXT_AMP_VOLUME = yes
ENABLE_AMAZON_HAL_EFFECTS = true
TARGET_PREBUILT_TEE = vendor/amazon/signed-images/$(MTK_PROJECT)/$(TARGET_BUILD_VARIANT)/tz.img
BOARD_UFBL_PROJECT = douglas
TARGET_MDUMP_COMPRESS = yes
BOARD_AMAZON_KERNEL_SIGNING = true
IDME_SUPPORT = yes
TARGET_PREBUILT_PRELOADER = vendor/amazon/signed-images/douglas/$(TARGET_BUILD_VARIANT)/preloader.bin
TARGET_PREBUILT_LK = vendor/amazon/signed-images/douglas/$(TARGET_BUILD_VARIANT)/lk.bin
